...
source_folder = "/mnt/tqsang/hand_only_part1"
image_folder = "/mnt/tqsang/chicken_part1/frames"
...
for i, xml_file in enumerate(xml_files):
    ...
    # Copy the image
    copyfile(image_path, os.path.join(target_image_folder, image_file))
    
    # Save the YOLO annotations
    with open(os.path.join(target_label_folder, f"{image_file[:-4]}.txt"), "w") as f:
