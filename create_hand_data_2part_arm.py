...
def convert_pascal_voc_to_yolo(xml_file):
    ...
    for obj in objects:
        class_id = int(obj.find("name").text)  # Change the class of all XML to 0 in YOLO
...
parts = [('part1', '/mnt/tqsang/hand_arm_part1', '/mnt/tqsang/chicken_part1/frames'),
         ('part2', '/mnt/tqsang/hand_arm_part2', '/mnt/tqsang/chicken_part2/frames')]

output_folder = "/mnt/tqsang/hand_dataset_YOLO"

for part, source_folder, image_folder in parts:
